        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="left-image">
                    ...
                    <a href="{{ route('property-details') }}"><img src="{{ asset('assets/images/featured-icon.png') }}" alt="" style="max-width: 60px; padding: 0px;"></a>
                </div>
            </div>
            <div class="col-lg-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    ...
                    <h6>$584.500</h6>
                    <h4><a href="{{ route('property-details') }}">12 New Street Miami, OR 12650</a></h4>
                    <ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    ...
                    <h6>$925.600</h6>
                    <h4><a href="{{ route('property-details') }}">34 Beach Street Miami, OR 42680</a></h4>
                    <ul>
                        <li>Bedrooms: <span>4</span></li>
                        <li>Bathrooms: <span>4</span></li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    ...
                    <h6>$450.000</h6>
                    <h4><a href="{{ route('property-details') }}">22 New Street Portland, OR 16540</a></h4>
                    <ul>
